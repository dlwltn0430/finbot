    ...
    <div>
      ...
      <div className="fixed left-0 top-0 z-30 flex h-screen w-[76px] flex-col items-center justify-between border-r border-gray2 bg-[#FBFBFB] pb-[44px] pt-[36px]">
        ...
        >
          ...
          {hoveredItem === 'setting' && (
            <div className="text-gray7 z-100 absolute bottom-1/2 left-full z-[9999] ml-[6px] flex w-[180px] translate-y-1/2 items-center gap-[8px] whitespace-nowrap rounded-[4px] border border-gray2 bg-white px-[40px] py-[12px] text-[16px] font-[600] shadow-[0_0_4px_rgba(27,27,27,0.04)]">
              <img
                src={memoryIcon}
                alt="memory"
